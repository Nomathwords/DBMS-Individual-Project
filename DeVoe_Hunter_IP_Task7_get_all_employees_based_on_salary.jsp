...
<html>
    ...
    <body>
        ...
        <%
        	...
        	if(Salary_Temp.equals("")) {
        		response.sendRedirect("get_all_employees_based_on_salary_form.jsp");
        	}
        	
        	int SalaryInteger = Integer.parseInt(Salary_Temp);
            // We instantiate the data handler here, and get all the movies from the database
            final DataHandler handler = new DataHandler();
            final ResultSet Employees = handler.getAllEmployeesBasedOnSalary(SalaryInteger);
        %>
